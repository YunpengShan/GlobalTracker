...
class VisitedListViewController: UIViewController, VisitedViewControllerDelegate {
                ...
                if let documents = snapshot?.documents {
                    ...
                    for document in documents {
                        ...
                        if let visitedCountryName = data["visitedCountryName"] as? String {
                            ...
                            self.countryNames.append(visitedCountryName)
                        }
                    }
...
extension VisitedListViewController: UITableViewDataSource {
...
extension VisitedListViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            userCountryRef.whereField("visitedCountryName", isEqualTo: deletedCountryName).getDocuments { (snapshot, error) in
                if let error = error {
